...
abstract class Styles {
  ...
  static var cancelElevatedButtonTheme = ElevatedButton.styleFrom(
    primary: ColorsValue.whiteColor,
  ...
  static var cancleElevatedButtonTheme = ElevatedButton.styleFrom(
    primary: ColorsValue.whiteColor,
